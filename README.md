...
This project is a follow-up to the following paper: Deep Impact: A Study on the Impact of Data Papers and Datasets in the Humanities and Social Sciences. Its aim is to automate the linking between data and research papers.
